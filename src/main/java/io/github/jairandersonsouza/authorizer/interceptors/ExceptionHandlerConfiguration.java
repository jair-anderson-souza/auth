...
public class ExceptionHandlerConfiguration {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseBuilder handleBusinessException(final AccountNotExistsException accountNotExistsException) {
        return ResponseBuilder
                .builder()
                .code(GENERIC_PROBLEM)
                .build();
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseBuilder handleTransactionRejectedException(final Exception exception) {
        return ResponseBuilder
                .builder()
                .code(REJECTED)
                .build();
