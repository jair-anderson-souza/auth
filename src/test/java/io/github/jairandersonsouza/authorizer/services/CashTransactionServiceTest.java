...
class CashTransactionServiceTest {
    ...
    void testShouldProcessCashPayment() {
        ...
        var transactionDTO = TransactionUtil.makeTransactionDTO("1123", new BigDecimal(100), CASH.name(), "Google");
    ...
    void testShouldSaveTransaction() {
        var transaction = TransactionUtil.makeTransaction(TransactionUtil.makeTransactionDTO("1123", new BigDecimal(100), CASH.name(), "Google"));
        when(transactionRepository.save(any(Transaction.class))).thenReturn(transaction);
